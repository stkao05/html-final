...
if __name__ == '__main__':
    # load data
    train_data = pd.read_csv('./data/task1/train_data.csv')
    ...
    test_data = pd.read_csv('./data/task1/same_season_test_data.csv')
    ...
    # inference
    predict_and_save(model, X_test, test_data, './data/task1_results.csv')